                  ...
                  <form class="" action="03-2-2-self-test.php" method="post">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <div class="form-floating mb-3">
                            ...
                            <label for="floatingSelect">문항 개수</label>
                        </div>
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect"
                                aria-label="Floating label select example"
                            ...
                            <label for="floatingSelect">과목</label>
                            <br>
                             <button type="submit" class="btn btn-danger m-2" onclick="location.href='table.html'">테스트시작</button>
                        </div>
                    </div>
                  </form>
            </div>

...
<head>
    ...
    <script src="wavesurfer.js-master/src/wavesurfer.js"></script>
...
<body>
    <script type="module" src="wavesurfer.js-master/src/wavesurfer.js"></script>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <?php
              ...
              $fp_file = fopen("$file", "r") or die("파일을 열 수 없습니다.");
            ?>
            <h1 style="margin-top: 5%;margin-left:1em"><?php echo $rows['title']; ?></h1>
            <b style="margin-top: 1%;margin-left:2em"><?php echo $rows['Name']; ?></b>
            <div style="margin-top: 1%;margin-bottom: 1%;margin-left:2em"><?php echo $rows['date'] ?></div>
            <hr>
            <div id="main">
              <div style="width:100%;height: 95%;text-align: center;">
                <div style="margin-top: 1%;margin-bottom: 1%;">
                  <img src="soundwave.png" alt="" width="400em" height="55em" style="margin-bottom: 2em"><br>
                  <audio controls>
                      <source src="<?php echo $file2 ?>" type="audio/mpeg">
                  </audio>

                  <hr>
                  <form class="" action="index.html" method="post" style="text-align:left;margin-left:2em;margin-right:2em;">
                    <?php
                      // 파일 내용 출력
                      while( !feof($fp_file) ) {
                      echo fgets($fp_file), "<br>\n";
                      }
              ...
              <hr >
              <div id="allBtn">
                <button class="logoutBtn" onclick="location.href='02-1-classroomBoarder.php'">목록</button>
                <button class="logoutBtn" onclick="location.href='02-1-classroomBoarder.php'">수정 </button>
                <?php if(isset($_SESSION['name']) and $_SESSION['name'] == $rows['Name'] or $_SESSION['authority'] === 's' or $_SESSION['authority'] === 'm') { ?>
                <button class="logoutBtn" onclick="location.href='modify.php?number=<?= $number ?>&id=<?= $_SESSION['studentID'] ?> '" hidden>수정</button>
            ...
            <!-- <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        ...
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="">메인페이지로 돌아가기</a>
                    </div>
                </div>
            </div> -->
            <!-- 404 End -->

         ...
         <div class="sidebar pe-4 pb-3">
             <nav class="navbar bg-light navbar-light">
                 <a href="01-index.php" class="navbar-brand mx-4 mb-3">
                     <h4 class="text-primary"><i class="fa fa-hashtag me-2"></i>Running Factory</h4>
                 </a>
                ...
                <form class="" action="php/checkScore.php" method="post">
                  <div class="row g-4">
                      ...
                      for ($a = 1; $a <= $count; $a++){
                        ...
                        $rows = mysqli_fetch_assoc($result);
                          if($rows['category'] == '4choice'){
                            ?>
                            <form class="" action="03-2-2-self-test.php" method="post">
                              <div class="col-12">
                                  <div class="bg-light rounded h-100 p-4">
                                      <h6 class="mb-4"><?php echo $a?>번 문제</h6>
                                      <div class="table-responsive">
                                          <table class="table">
                                              <thead>
                                                  <tr>
                                                      <th scope="col" width="50"></th>
                                                      <th scope="col"><?php echo $rows['Q'] ?></th>
                                                      <th scope="col"></th>
                    ...
                    ?>
                       ...
                       <!-- 정답 -->
                       <select class="" name="answer" hidden>
                         <option value="<?php echo $Q_num ?>" selected><?php echo $a ?></option>
                       </select>
                           ...
                           <div class="btn-group" role="group">
                                   <button type="button" class="btn btn-danger" onclick="03-2-1-self-test.php">뒤로</button>
                 ...
                 <div class="bg-light rounded-top p-4">
                     <div class="row">
                         ...
                         <div class="col-12 col-sm-6 text-center text-sm-end">
                             ...
                             Designed By <a href="https://www.naver.com">Team Deep.Insight</a>
                         </br>
                         Distributed By <a class="border-bottom" href="https://www.naver.com" target="_blank">한국폴리텍대학 서울정수캠퍼스</a>
                         </div>
                     </div>
                 </div>
             </div>

        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                  <form action="php/fbwrite_action.php" method="post">
                    <h1><a href="/">자유게시판</a></h1>
                    <h4>글을 작성하는 공간입니다.</h4>
                    <div id="title">
                      <textarea name="title" rows="1" cols="50" placeholder="제목을 입력하세요."></textarea>
                    </div>
                    <div id="smarteditor">
                      <textarea name="content" id="content" rows="20" cols="10" style="width:100%" placeholder="내용을 입력하세요."></textarea>
                    </div>

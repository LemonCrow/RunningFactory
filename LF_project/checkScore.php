<?php
  ...
  $count = $_POST['count']-1; //문제 개수
  $q_idx= $_POST['q_idx']; //문제 idx 번호
  $Q = $_POST['Q']; //체크한 정답



  // $query = "SELECT * FROM $subject where $q_idx";
        ...
        <!-- Sidebar End -->
         ...
         <div class="content">
             ...
             <div class="container-fluid pt-4 px-4">
                <form class="" action="php/checkScore.php" method="post">
                  <div class="row g-4">
                    <?php
                      for ($a = 1; $a <= $count; $a++){
                        $query = "SELECT * FROM $subject where idx = $q_idx[$a]";
                        $result = mysqli_query($connect, $query);

                        $rows = mysqli_fetch_assoc($result);
                        //정답에 따라 div 색상 변경? s
                          if ($rows['A0'] == $Q[$a]){
                              ?><h3 style="background-color:skyblue;">정답입니다.</h3><?php
                          } else{
                              ?><h3 style="background-color:pink;">오답입니다.</h3><?php
                          }
                          ...
                          if($rows['category'] == '4choice'){
                            ?>
                              <div class="col-12">
                                  <div class="bg-light rounded h-100 p-4">
                                      <h4 class="mb-4"><?php echo $a?>번 문제 정답: <?php echo $rows['A0'] ?>번</h4>
                                                  ...
                                                  if ($Q[$a] == '1'){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                ...
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A1" checked>
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A1">
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                  ...
                                                  if ($Q[$a] == '2'){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A2" checked>
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A2">
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                  ...
                                                  if ($Q[$a] == '3'){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A3" checked>
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A3">
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                  ...
                                                  if ($Q[$a] == '4'){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A4" checked>
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A4">
                                                            </div>
                                                        </td>
                                                        <!-- <td>USA</td>
                                                        <td>123</td>
                                                ...
                                                if ($Q[$a] == '5'){
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="form-check">
                                                              <input class="form-check-input" type="radio"
                                                              name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A5" checked>
                                                          </div>
                                                      </td>
                                                      <!-- <td>USA</td>
                                                      <td>123</td>
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="form-check">
                                                              <input class="form-check-input" type="radio"
                                                              name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="A5">
                                                          </div>
                                                      </td>
                                                      <!-- <td>USA</td>
                                                      <td>123</td>
                            ...
                            <div class="col-12">
                                <div class="bg-light rounded h-100 p-4">
                                    <h4 class="mb-4"><?php echo $a?>번 문제 정답: <?php echo $rows['A0'] ?></h4>
                                    <div class="table-responsive">
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <?php
                                                      if ($Q[$a] == 'O'){
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="O" checked>
                                                            </div>
                                                        </td>
                                                        <?php
                                                      } else{
                                                    ...
                                                    <?php
                                                      if ($Q[$a] == 'X'){
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="radio"
                                                                name="Q[<?php echo $a?>]" id="flexRadioDefault2" value="X" checked>
                                                            </div>
                                                        </td>
                                                        <?php
                                                      } else{
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                      ...
                                                      placeholder="답안을 작성하세요." aria-label=".form-control-sm example" name="Q[<?php echo $a?>]" value="<?php echo $Q[$a] ?>">
                                                    </td>
                                                    <td>

            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="05-01-myInfo.php" class="dropdown-item">내정보</a>
                            <?php
                            if ($authority === 'm') {
                            ?>
                            <a href="05-2-admin.php" class="dropdown-item">관리자</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="content">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="https://www.kopo.ac.kr/ckimage/2022/11/1VpQawBHdTko4wlUFOQn.jpg" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="https://cdn.imweb.me/upload/S20211110a3d216dc49446/f7bfffacbb6de.png" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">정폴리님이 메시지를 보냈습니다.</h6>
                                        <small>1시간 전</small>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="#" class="dropdown-item">
                                <div class="d-flex align-items-center">
                                    <img class="rounded-circle" src="https://kopo.ac.kr/images/kopo/ui_symbol.png" alt="" style="width: 40px; height: 40px;">
                                    <div class="ms-2">
                                        <h6 class="fw-normal mb-0">교무기획처님이 메시지를 보냈습니다.</h6>
                                        <small>2일 전</small>
                                    </div>
                                </div>
                            </a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                    ...
                    <div class="ms-3">
                        <p class="mb-2">오늘방문자</p>
                        <h6 class="mb-0">166명</h6>
                    </div>
                    <i class="fa fa-chart-area fa-3x text-primary"></i>
                    <div class="ms-3">
                        <p class="mb-2">누적방문자</p>
                        <h6 class="mb-0">399842명</h6>
                            </div>
                 </div>
                <div class="row g-4">
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <h6 class="mb-0">할 일</h6>
                                <a href="">전체보기</a>
                            </div>
                            <div class="d-flex mb-2">
                                <input class="form-control bg-transparent" type="text" placeholder="할일 내용 작성">
                    ...
                    <div class="col-sm-12 col-md-6 col-xl-4">
                        <div class="h-100 bg-light rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h6 class="mb-0">메시지함</h6>
                                <a href="">전체보기</a>
                            </div>
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="https://www.kopo.ac.kr/ckimage/2022/11/1VpQawBHdTko4wlUFOQn.jpg" alt="" style="width: 40px; height: 40px;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-0">이영주</h6>
                                        <small>15분 전</small>
                                    </div>
                                    <span>정재현 학생, 오늘 제 연구실로 방문 바..</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="https://cdn.imweb.me/upload/S20211110a3d216dc49446/f7bfffacbb6de.png" alt="" style="width: 40px; height: 40px;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-0">정폴리</h6>
                                        <small>1시간 전</small>
                                    </div>
                                    <span>오늘 과제 뭐였지?</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center border-bottom py-3">
                                <img class="rounded-circle flex-shrink-0" src="https://kopo.ac.kr/images/kopo/ui_symbol.png" alt="" style="width: 40px; height: 40px;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-0">교무기획처</h6>
                                        <small>1시간 전</small>
                                    </div>
                                    <span>정재현 학생의 건의사항이 접수되었습..</span>
                                </div>
                            </div>
                            <div class="d-flex align-items-center pt-3">
                                <img class="rounded-circle flex-shrink-0" src="https://img.tvreportcdn.de/cms-content/uploads/2021/11/04/a93528eb-3f81-44d8-9fb2-4ac067719b82.jpg" alt="" style="width: 40px; height: 40px;">
                                <div class="w-100 ms-3">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h6 class="mb-0">박시디</h6>
                                        <small>2시간 전</small>
                                    </div>
                                    <span>안녕하세요 시디과 박시디라고 합니다.</span>
                                </div>
                            </div>
                        </div>
                    </div>

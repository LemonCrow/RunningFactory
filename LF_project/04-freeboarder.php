        ...
        <div class="content">
            ...
            <!-- tbl_list 게시판목록 :: s -->
                    ...
                    <!-- 컨텐츠 게시판 테이블  -->
                      ...
                      <tbody>
                        ...
                        while ($rows = mysqli_fetch_assoc($result)) { //result set에서 레코드(행)를 1개씩 리턴
                            ...
                            $r = mysqli_query($connect, $reply_count);
                            $con_reply_count = mysqli_fetch_array($r);
                            ?>
                                <td class="num">
                                  <a href="04-2-freeboarderRead.php?number=<?php echo $rows['idx']; ?>" class="a1">
                                  <?php echo $page_set; ?>
                                </td>
                                 <td class="b_subject ">
                                  <span>
                                    <a href="04-2-freeboarderRead.php?number=<?php echo $rows['idx']; ?>" class="a1">
                                    <?php echo $rows['title']."[".$con_reply_count["cnt"]."]"; ?></a>
                                  </span>
                                </td>
                                <td>
                                  <a href="04-2-freeboarderRead.php?number=<?php echo $rows['idx']; ?>" class="a1">
                  ...
                  <div class="btnbox_basic">
                      ...
                      <a href="04-1-freeboarderWrite.php" class="btn_basic"><span>글쓰기</span></a>
                      </div>
                    </div>

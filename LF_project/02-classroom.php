        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">강의실</h6>
                    <form class="" action="02-1-classroomBoarder.php" method="post">
                      <div class="form-floating mb-3">
                          ...
                          <label for="floatingSelect">학년 / 학기</label>
                      </div>
                      <div class="form-floating mb-3">
                          <select class="form-select" id="floatingSelect"
                              aria-label="Floating label select example">
                          ...
                          <label for="floatingSelect">전공 / 교양</label>
                          <br>
                           <button type="button" class="btn btn-primary m-2" onclick="location.href='02-1-classroomBoarder.php'">강의검색</button>
                      </div>
                    </form>
                </div>
            </div>

...
class __TwigTemplate_320b2cb79c5ce0844892eb49ed5bd3c82627e8d6f572cb0feeba77aa1170c34b extends Template
{
    private $source;
    private $macros = [];
...
($context["type"] ?? null), "list"))) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["val"]) {
                if ((0 !== twig_compare($context["key"], "wrapper_params"))) {
                    echo twig_escape_filter($this->env, $context["val"], "html", null, true);
...
";
    ...
    {
        return new Source("", "config/form_display/input.twig", "/zerosugarlime/www/adminer/templates/config/form_display/input.twig");
    }
}

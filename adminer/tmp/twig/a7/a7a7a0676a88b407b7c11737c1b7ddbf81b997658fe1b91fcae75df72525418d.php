...
class __TwigTemplate_186a63e09e5f6180b32c8b7ee95d7dcfb4fb1aa01897c5c2f5f46d0f7dddf96b extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Home");
          ...
          ";
            ...
            if ((0 !== twig_compare(($context["server"] ?? null), 0))) {
                ...
                echo "\">";
                // line 31
                echo PhpMyAdmin\Html\Generator::getImage("s_loggoff", (((0 === twig_compare(($context["auth_type"] ?? null), "config"))) ? (_gettext("Empty session data")) : (_gettext("Log out"))));
                // line 32
                echo "</a>
          ";
            }
...
";
    ...
    {
        return new Source("", "navigation/main.twig", "/zerosugarlime/www/adminer/templates/navigation/main.twig");
    }
}

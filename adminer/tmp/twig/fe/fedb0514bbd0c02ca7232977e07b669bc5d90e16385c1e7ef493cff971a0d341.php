...
class __TwigTemplate_3e7d0eca2db3f6091548d7faec8a8614004f510d52b6c4d070e674c87d2d87a7 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Wk");
  ...
  \$.datepicker.regional[''].showMonthAfterYear = ";
        // line 75
        echo (((0 === twig_compare(($context["show_month_after_year"] ?? null), "calendar-year-month"))) ? ("true") : ("false"));
        echo ";
  \$.datepicker.regional[''].yearSuffix = '";
        // line 76
        echo (((0 !== twig_compare(($context["year_suffix"] ?? null), "none"))) ? (twig_escape_filter($this->env, ($context["year_suffix"] ?? null), "js")) : (""));
        echo "';
...
";
    ...
    {
        return new Source("", "javascript/variables.twig", "/zerosugarlime/www/adminer/templates/javascript/variables.twig");
    }
}
